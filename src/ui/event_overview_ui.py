from PyQt5.QtWidgets import (
    QWidget, QVBoxLayout, QSizePolicy, QLabel, QHBoxLayout, QPushButton, QListWidget, QListWidgetItem, QFrame, QTabWidget
)
from PyQt5.QtCore import Qt, QTimer
from src.ui.theme import apply_styles
from src.ui.event_manager_helper import get_all_events, get_main_event, get_main_event_result
from src.ui.weekly_show_settings_ui import WeeklyShowSettingsUI
...
class EventOverviewUI(QWidget):
    ...
    def get_today(self):
        ...
        return datetime.strptime(get_game_date(), "%A, %d %B %Y").date()
